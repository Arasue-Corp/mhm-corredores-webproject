...
# Make the Registrar button go to page 5.
# Right now it has onclick="document.getElementById('successModal').style.display = 'flex';"
html4 = html4.replace("document.getElementById('successModal').style.display = 'flex';", "window.location.href='cotizacion-vehicular-5.html';")
