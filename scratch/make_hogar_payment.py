...
# Remove the 'Registro Beneficiarios' step from the sidebar entirely
html = html.replace('<li><i class="fa-regular fa-circle"></i> Registro Beneficiarios</li>', '')

# Since we skipped 'Datos Personales' (Step 2 of escolar), we should probably make the sidebar reflect that.
# In Escolar 3, Datos Personales is a checked step. 
# Let's remove Datos Personales from the sidebar to match a 2-step flow (Plan -> Payment).
...
print(f"Created {dst} perfectly matching escolar-3.")
