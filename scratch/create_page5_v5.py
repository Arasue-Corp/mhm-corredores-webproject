...
# Find the start of the sidebar: <div class="sidebar-col">
sidebar_start = html.find('<div class="sidebar-col">')
...
if main_start != -1 and sidebar_start != -1:
    ...
    new_main_content = '''<div class="main-spec-col">
        <div class="premium-white-card" style="display: flex; justify-content: center; align-items: center; min-height: 400px; padding: 40px 20px;">
